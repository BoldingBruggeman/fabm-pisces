...
module pisces_nitrification
   ...
   type, extends(type_base_model), public :: type_pisces_nitrification
      ...
      type (type_dependency_id) :: id_nitrfac
      type (type_surface_dependency_id) :: id_fr_i, id_emoy
...
contains
   ...
   subroutine do(self, _ARGUMENTS_DO_)
      ...
      real(rk) :: no3, nh4, nitrfac, emoy, fr_i
      ...
      _LOOP_BEGIN_
         ...
         _GET_SURFACE_(self%id_emoy, emoy)  ! instantaneous PAR averaged over mixing layer (W m-2)  - TODO check if this needs to be for ice-free water
         ...
         ! ----------------------------------------------------------
         zonitr  = self%nitrif * xstep * nh4 * ( 1.- nitrfac )  &    ! Jorn: Eq 56 (but TODO: verify emoy - fr_i treatment)
         &         / ( 1.+ emoy ) * ( 1. + fr_i * emoy ) 
