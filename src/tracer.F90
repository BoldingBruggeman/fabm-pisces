...
contains
   ...
   subroutine initialize(self, configunit)
      ...
      if (has_carbon .or. has_nitrogen .or. has_phosphorus) then
         call self%register_state_variable(self%id_c, 'c', 'mol C L-1', 'concentration in carbon units')
      ...
      if (has_iron) then
         call self%register_state_variable(self%id_fe, 'fe', 'mol Fe L-1', 'concentration in iron units')
